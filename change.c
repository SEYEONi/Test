...
int main(int argc, char **argv)
{
    ...
    fscanf(input, "%d", &block_length);
    fscanf(input, "%d", &wall_length);

    printf("block: %d, wall: %d\n", block_length, wall_length);
    ...
    fprintf(output, "%d %d", answer_num, answer_height);
    fclose(output);
